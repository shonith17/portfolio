...
const element3 = document.getElementById('scroll-icon-arrow');
...
const scrollIcon = document.getElementById('scroll-icon-arrow');
const scrollText = document.getElementById('icon-text');
...
function handleScroll() {
  if (window.scrollY >= 500) {
    ...
    scrollIcon.style.animation = 'bounceUp 1s ease-in-out 4s infinite alternate';
    scrollText.style.animation = 'bounceUp 1s ease-in-out 4s infinite alternate';
  }
}
